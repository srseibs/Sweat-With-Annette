...
class WorkoutHistoryRepositoryImpl @Inject constructor(
    ...
    override suspend fun setActiveWorkoutSetName(workoutSetName: String) = withContext(Dispatchers.IO) {
    ...
    override suspend fun setMasterExerciseList(masterList: List<ExerciseMasterEntity>) = withContext(Dispatchers.IO) {
